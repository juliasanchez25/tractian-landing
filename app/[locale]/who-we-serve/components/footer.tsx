    ...
    <footer className="bg-[#0a1628] px-4 py-12 lg:py-20">
      <div className="mx-auto flex w-full max-w-7xl flex-col">
        ...
        <section className="mb-8 flex w-full flex-col gap-x-16 gap-y-8 lg:mb-12 lg:flex-row lg:items-center lg:justify-between">
          ...
          <a
            className="hidden items-center gap-x-2 self-end text-slate-50 transition hover:text-blue-300 lg:flex"
            href="#"
          >
        ...
        <section className="border-t border-slate-800 pt-8">
          <div className="flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-col items-start gap-6 lg:items-end">
              ...
              {/* Endereço */}
              <p className="text-slate-400 text-sm text-left lg:text-right">
                {t("address")}
              </p>

              {/* Privacy choices */}
              <button className="flex items-center gap-2 text-slate-400 text-sm hover:text-white transition">
