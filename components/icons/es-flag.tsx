export const ESFlag = () => (
  ...
  >
    ...
    <rect fill="#FFD250" height="194.21" width="512" y="158.9"></rect>
    <path
    ...
    <path
      ...
      fill="#FFA0D2"
    ></path>
    <circle cx="150.07" cy="273.65" fill="#5064AA" r="13.241"></circle>
    <rect
      fill="#FAB446"
      height="26.483"
      width="8.828"
    ...
    ></path>
    <g>
      <circle cx="150.07" cy="211.86" fill="#FFD250" r="4.414"></circle>
      <circle cx="132.41" cy="211.86" fill="#FFD250" r="4.414"></circle>
      <circle cx="167.72" cy="211.86" fill="#FFD250" r="4.414"></circle>
    </g>
    <g>
      <rect
        fill="#C8414B"
